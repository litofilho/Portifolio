...
(function ($) {
    ...
    $.extend($.fn.bootstrapTable.defaults, {
        ...
        filterTemplate: {
            input: function (that, field, isVisible, placeholder) {
                return sprintf('<input type="text" class="form-control bootstrap-table-filter-control-%s" style="width: 100%; visibility: %s" placeholder="Buscar na Coluna">', field, isVisible, placeholder);
            },
    ...
    BootstrapTable.prototype.initColumnSearch = function( ) {
        copyValues(this);
